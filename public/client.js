...
// ---------- 패치 노트 (버전 배지 클릭 시 팝업) ----------
const PATCH_NOTES = [
  ['v88~94', ['접속자 목록 호버 팝오버 · 버전 클릭 시 패치 노트', '방 만들기에 시작 스택(BB) 설정 추가', '모바일 좌석 균등 분산 · 테이블 위치/크기 조정', '현재 차례 좌석이 살짝 커지는 강조 애니메이션', '쇼다운 승리배너를 보드 아래로 이동(카드 안 가림)', '하단 버튼/이모지 축소 → 테이블 더 크게', '참여하기 방코드 입력칸 표시 수정']],
